...
Public Class frmAssignJob

    Private Sub frmAssignJob_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        frmMain.Show()
    End Sub

    Private Sub frmAssignJob_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
